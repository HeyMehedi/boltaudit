  ...
  return (
    <div id="ba-dashboard__plugins" className="ba-dashboard__content__section">
      ...
      <p className="ba-dashboard__content__section__desc">
        Get a quick overview of your site’s plugins—what’s active, inactive,
        outdated, or abandoned.
        <br />
        Spot bloat, reduce risks, and keep your stack lean by identifying what’s
        helping and what’s just hanging around.
      </p>
              ...
              <tbody>
                {pluginData?.plugins.map((plugin, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      {plugin.is_active ? (
                        <Link to={`/plugin/${plugin.slug}`} className="action">
                          Check{" "}
