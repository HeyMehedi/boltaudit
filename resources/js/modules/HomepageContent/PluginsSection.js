...
export default function PluginsSection() {
  ...
  useEffect(() => {
    postData("boltaudit/reports/plugins").then((res) => {
      setPluginData(res);
      setLoading(false);
    });
  }, []);
  ...
  return pluginData ? (
    <div id="ba-dashboard__plugins" className="ba-dashboard__content__section">
      <h4 className="ba-dashboard__content__section__title">Plugin Audit</h4>

      <p className="ba-dashboard__content__section__desc">
        Get a quick overview of your site’s plugins—what’s active, inactive, outdated, or abandoned.<br/>
        Spot bloat, reduce risks, and keep your stack lean by identifying what’s helping and what’s just hanging around.
      </p>
      ...
      <div className="ba-dashboard__content__section__content">
        <div className="ba-dashboard__content__section__overview equal-height">
          <div className="ba-dashboard__content__section__overview__single">
            <span className="ba-dashboard__content__section__overview__title">Total</span>
            <span className="ba-dashboard__content__section__overview__count">
              <CountUp target={pluginData.counts.total} />
            </span>
          </div>
          <div className="ba-dashboard__content__section__overview__single">
            <span className="ba-dashboard__content__section__overview__title">Active</span>
            <span className="ba-dashboard__content__section__overview__count">
              <CountUp target={pluginData.counts.active} />
            </span>
          </div>
          <div className="ba-dashboard__content__section__overview__single">
            <span className="ba-dashboard__content__section__overview__title">Inactive</span>
            <span className="ba-dashboard__content__section__overview__count">
              <CountUp target={pluginData.counts.inactive} />
            </span>
          </div>
          <div className="ba-dashboard__content__section__overview__single">
            <span className="ba-dashboard__content__section__overview__title">Abandoned</span>
            <span className="ba-dashboard__content__section__overview__count">
              ...
              <tr>
                ...
                <th>
                  ...
                  <span className="bs-dashboard-tooltip">
                    ...
                    <span className="bs-dashboard-tooltip-content">Upcoming</span>
                  </span>
                </th>
              </tr>
            </thead>
              ...
              <tr key={index}>
                ...
                <td>
                  <a href="#" className="action">
                    Check <ReactSVG src={arrowRightIcon} width={16} height={16} />
                  </a>
                </td>
              </tr>
            ))}
