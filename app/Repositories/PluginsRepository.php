    ...
    public static function get_plugins_data() {
        ...
        foreach ( $all_plugins as $plugin_file => $plugin_data ) {
            ...
            if ( $cached_entry && ! empty( $cached_entry['data'] ) ) {
                ...
                if ( class_exists( '\\BoltAudit\\App\\Repositories\\SinglePluginRepository' ) &&
                        method_exists( '\\BoltAudit\\App\\Repositories\\SinglePluginRepository', 'get_plugin_metrics' )
                            ) {
                    $metrics = \BoltAudit\App\Repositories\SinglePluginRepository::get_plugin_metrics( $plugin_file );
                    if ( is_array( $metrics ) ) {
